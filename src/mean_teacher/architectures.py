...
def resnext50(pretrained=False, **kwargs):
    ...
    model = ResNet224x224(BottleneckBlock,
                          ...
                          channels=32 * 4,
                          groups=32,
                          downsample='basic', c_in=1, dropout_rate=0.1, **kwargs)
    return model
...
class ResNet224x224(nn.Module):
    def __init__(self, block, layers, channels, groups=1, num_classes=1000, downsample='basic', c_in=3, dropout_rate=0.0):
        super().__init__()
        assert len(layers) == 4
...
def resnext50_32x4d(pretrained=True, **kwargs):
    return PretrainedModel('resnext50_32x4d', num_classes=kwargs['num_classes'])

@export
def vgg16(pretrained=True, **kwargs):
    return PretrainedModel('vgg16', num_classes=kwargs['num_classes'])
    
@export
def resnet50(pretrained=True, **kwargs):
    return PretrainedModel('resnet50', num_classes=kwargs['num_classes'])