...
def create_parser():
    ...
    parser.add_argument('--entmin', default=0.0, type=float)
    parser.add_argument('--slice-reg', default=0.0, type=float)
    parser.add_argument('--brain-consistency', default=0.0, type=float)
    parser.add_argument('--brain-weight', default=1.0, type=float)
    parser.add_argument('--brain-consistency-type', default="kl", type=str, metavar='TYPE',
                        choices=['mse', 'kl'], help='brain consistency loss type to use')
    parser.add_argument('--num-label', default=0, type=int)
    return parser
